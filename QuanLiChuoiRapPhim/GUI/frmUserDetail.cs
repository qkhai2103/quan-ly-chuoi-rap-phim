...
namespace QuanLiChuoiRapPhim.GUI
{
    public partial class frmUserDetail : Form
    {
        ...
        private int? userId = null; // null = th�m m?i, c� gi� tr? = s?a
        ...
        private void LoadData()
        {
            ...
            if (userId.HasValue && userId.Value > 0)
            {
                try
                {
                    ...
                    txtUsername.Enabled = false; // Kh�ng cho s?a t�n ��ng nh?p
                    ...
                    else if (role == "QuanLy") cboRole.SelectedItem = "Quản lý";
                    else if (role == "NhanVien") cboRole.SelectedItem = "Nhân viên";
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else if (roleDisplayName.Contains("Quản lý") || roleDisplayName.Contains("Quan ly") || roleDisplayName.Contains("Qu?n l?")) role = "QuanLy";
                else role = "NhanVien";
                ...
                if (userId.HasValue)
                {
                    ...
                    if (success)
                    {
                        MessageBox.Show("C?p nh?t ng�?i d�ng th�nh c�ng!", "Th�nh c�ng",
        ...
        private bool ValidateInput()
        {
            ...
            // Ki?m tra m?t kh?u (ch? b?t bu?c khi th�m m?i)
            if (!userId.HasValue)
            {
            ...
            if (!string.IsNullOrWhiteSpace(txtEmail.Text))
            {
                ...
                {
                    MessageBox.Show("Email kh�ng h?p l?!", "C?nh b�o",
                        MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtEmail.Focus();
                    return false;
                }
