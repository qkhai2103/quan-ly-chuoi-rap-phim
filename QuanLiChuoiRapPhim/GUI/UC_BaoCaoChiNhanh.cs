...
namespace QuanLiChuoiRapPhim.GUI
{
    public partial class UC_BaoCaoChiNhanh : UserControl
    {
        ...
        private void ThietLapGiaoDien()
        {
            ...
            lblTongDoanhThu = TaoLabelThongKe("T?NG DOANH THU: 0 ð", Color.FromArgb(40, 167, 69), new Point(20, 25));
            lblTongHoaDon = TaoLabelThongKe("T?NG HÓA ÐÕN: 0", Color.FromArgb(0, 123, 255), new Point(250, 25));
        ...
        private void ThietLapTabTongQuan()
        {
            ...
            {
                Text = "?? S?N PH?M BÁN CH?Y: Ðang t?i...",
                Font = new Font("Segoe UI", 10, FontStyle.Bold),
                ForeColor = Color.FromArgb(52, 73, 94),
            ...
            {
                Text = "?? NHÂN VIÊN XU?T S?C: Ðang t?i...",
                Font = new Font("Segoe UI", 10, FontStyle.Bold),
                ForeColor = Color.FromArgb(52, 73, 94),
        ...
        private void TaoChartPhim()
        {
            ...
            Title title = new Title("TOP PHIM BÁN CH?Y", Docking.Top,
                new Font("Segoe UI", 14, FontStyle.Bold), Color.FromArgb(52, 73, 94));
        ...
        private void TaoChartNhanVien()
        {
            ...
            Title title = new Title("HI?U SU?T NHÂN VIÊN", Docking.Top,
                new Font("Segoe UI", 14, FontStyle.Bold), Color.FromArgb(52, 73, 94));
        ...
        private void TaiBaoCaoTongQuan(DateTime tuNgay, DateTime denNgay)
        {
            string query = @"
                SELECT 
                    'S? hóa ðõn' AS ChiTieu,
                    COUNT(DISTINCT hd.MaHoaDon) AS GiaTri,
                    'T?ng s? hóa ðõn' AS MoTa
                FROM HoaDon hd
