...
namespace QuanLiChuoiRapPhim.GUI
{
    public partial class UC_DonXinNghi : UserControl
    {
        ...
        private void ThietLapGiaoDien()
        {
            ...
            cboLoaiNghiFilter.Items.AddRange(new string[] { "T?t c?", "Phep", "KhongPhep", "OmBenh", "Huy", "KhongPhepODai" });
        ...
        private void TaoPanelChiTiet()
        {
            ...
            // M? ðõn
            lblMaDon = TaoLabelChiTiet("M? ðõn:", yPos);
            yPos += 30;
            ...
            // Lo?i ngh?
            lblLoaiNghi = TaoLabelChiTiet("Lo?i ngh?:", yPos);
            yPos += 30;

            // Ngày ngh?
            lblNgayNghi = TaoLabelChiTiet("Ngày ngh?:", yPos);
            yPos += 30;

            // S? ngày
            lblSoNgay = TaoLabelChiTiet("S? ngày:", yPos);
            yPos += 30;

            // L? do
            lblLyDo = TaoLabelChiTiet("L? do:", yPos);
            yPos += 50;
            ...
            // Tr?ng thái
            lblTrangThai = TaoLabelChiTiet("Tr?ng thái:", yPos);
            yPos += 40;
        ...
        private void TaiDonXinNghi()
        {
            ...
            {
                MessageBox.Show("L?i t?i danh sách ðõn xin ngh?: " + ex.Message, "L?i",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                lblThongKe.Text = "L?i t?i d? li?u";
            }
        }
        ...
        private void HienThiChiTietDon(object maDon)
        {
            ...
            {
                MessageBox.Show("L?i hi?n th? chi ti?t: " + ex.Message, "L?i",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void CapNhatThongKe()
        {
            ...
            lblThongKe.Text = $"T?ng: {tongDon} ðõn | ? Ch?: {choDuyet} | ? Ð? duy?t: {daDuyet} | ? T? ch?i: {tuChoi}";
        }
        ...
        private void BtnDuyet_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("B?n có ch?c ch?n DUY?T ðõn xin ngh? này?", "Xác nh?n",
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(DatabaseConfig.ConnectionString))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            if (rows > 0)
                            {
                                MessageBox.Show("Ð? duy?t ðõn xin ngh? thành công!", "Thành công",
        ...
        private void BtnTuChoi_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("B?n có ch?c ch?n T? CH?I ðõn xin ngh? này?", "Xác nh?n",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    using (SqlConnection conn = new SqlConnection(DatabaseConfig.ConnectionString))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            if (rows > 0)
                            {
                                MessageBox.Show("Ð? t? ch?i ðõn xin ngh?!", "Thành công",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                                TaiDonXinNghi();
                            }
                        }
                ...
                {
                    MessageBox.Show("L?i t? ch?i ðõn: " + ex.Message, "L?i",
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
        ...
        private void BtnHuyDon_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("B?n có ch?c ch?n H?Y ðõn xin ngh? này?", "Xác nh?n",
                MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                try
                {
                    using (SqlConnection conn = new SqlConnection(DatabaseConfig.ConnectionString))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(query, conn))
                        {
                            ...
                            if (rows > 0)
                            {
                                MessageBox.Show("Ð? h?y ðõn xin ngh?!", "Thành công",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                                TaiDonXinNghi();
                            }
                        }
                ...
                {
                    MessageBox.Show("L?i h?y ðõn: " + ex.Message, "L?i",
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
